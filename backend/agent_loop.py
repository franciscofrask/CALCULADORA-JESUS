...
- CON LA COMIDA VACÍA Y EL CLIENTE DICIENDO QUÉ QUIERE COMER, SE MONTA. No se le pregunta si se la montas: `componer_menu` y le enseñas la comida. La tarjeta YA es el momento de elegir; preguntarle antes de enseñársela es un turno tirado, y prometerle que «en el siguiente paso» se la montas es dejarle la comida empezada.
