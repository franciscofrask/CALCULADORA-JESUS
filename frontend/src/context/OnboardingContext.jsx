...
const STEPS = [
    {
        ...
        description: 'Acá ves tus macros objetivo y cuánto llevás consumido hoy. Es tu vista rápida cada vez que entrás.',
    },
    {
        ...
        description: 'Desde acá llegás a todas las secciones: nutrición, rutina, reportes, asistente IA y más. Te las muestro una por una.',
    },
    {
        id: 'nut-controls', route: '/dashboard/nutrition',
        element: '[data-testid="nutrition-controls"]',
        title: 'Configurá tu día', side: 'bottom',
        description: 'Elegí si es día de entrenamiento o de descanso. Tus macros se ajustan automáticamente a cada tipo de día.',
    },
    {
        id: 'nut-meals', route: '/dashboard/nutrition',
        element: '[data-testid="meal-selector"], [data-testid="meals-accordion"]',
        title: 'Armá tus comidas', side: 'right', gate: 'nutrition-add-food',
        description: 'Acá están tus comidas del día. Tocá una y agregá un alimento. Si lo hacés ahora, te llevo solo al siguiente paso (o seguí con "Siguiente").',
    },
    {
        id: 'nut-prefs', route: '/dashboard/nutrition',
        element: '[data-testid="open-preferences-btn"]',
        title: 'Tus preferencias', side: 'bottom',
        description: 'La calculadora sugiere comida según lo que te gusta. Podés ajustar tus preferencias desde acá cuando quieras.',
    },
    {
        id: 'macros', route: '/dashboard/macro-calculator',
        element: '[data-testid="macros-content"]',
        title: 'Ajustar macros', side: 'right', align: 'start',
        description: 'Si tu entrenador lo indica, desde acá podés afinar tus macros manualmente. Por defecto los calculamos por vos.',
    },
    {
        id: 'reports', route: '/dashboard/reports',
        element: '[data-testid="weight-input"]',
        title: 'Tus reportes', side: 'bottom', align: 'start',
        description: 'En Reportes registrás tu peso y medidas cada semana. Ves tu evolución en gráficos y tu entrenador te da feedback.',
    },
    {
    ...
    },
    {
        ...
        description: 'En Chat hablás directo con tu entrenador. Te responde y te acompaña durante todo el plan.',
    },
    {
        ...
        description: 'En Rutina tenés tu plan de entrenamiento semana a semana, día por día, con los ejercicios programados.',
    },
    {
        id: 'checkins', route: '/dashboard/checkins',
        element: '[data-testid="checkins-content"]',
        title: 'Check-ins', side: 'bottom', align: 'start',
        description: 'En Check-ins registrás cómo te sentís: energía, sueño, estrés y fotos de progreso. Ayuda a ajustar tu plan.',
    },
    {
        id: 'profile', route: '/dashboard/profile',
        element: '[data-testid="body-data-card"]',
        title: 'Tu perfil', side: 'bottom', align: 'start',
        description: 'En Mi perfil mantené tu peso y % de grasa al día para que tus macros se calculen con precisión. Ahí también editás tus datos.',
    },
    {
        ...
        title: '¡Listo! 🎉',
        description: 'Ya conocés tu app. Tu siguiente paso es armar tu primer día de comida. Podés repetir este recorrido cuando quieras desde tu perfil.',
    },
];
