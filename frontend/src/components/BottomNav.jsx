...
const BottomNav = () => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border shadow-lg md:hidden" data-testid="bottom-nav">
                        ...
                        >
                            <item.icon 
                                className={`w-5 h-5 mb-1 transition-all duration-200 ${
                                    active ? 'text-brand-orange scale-110' : 'text-muted-foreground'
                                }`} 
