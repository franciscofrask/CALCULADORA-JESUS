...
export const PREFERENCE_CATEGORIES = [
    ...
    { id: 'carnes_blancas',   label: 'Otras carnes blancas',                       prefixes: ['2.6'],           icon: faBone },
    { id: 'carnes_rojas',     label: 'Otras carnes rojas',                         prefixes: ['2.7'],           icon: faFire },
    ...
    { id: 'helados',          label: 'Helados y postres',                          prefixes: ['44'],            icon: faSnowflake },
