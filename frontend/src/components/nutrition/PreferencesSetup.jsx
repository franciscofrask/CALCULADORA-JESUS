...
import {
    faBottleDroplet, faOilCan, faCookieBite, faBowlRice, faDove,
    faDumbbell, faBolt, faBottleWater, faBlender, faCakeCandles,
    faMugHot, faDrumstickBite, faPiggyBank, faPlateWheat, faCookie,
    faUtensils, faBurger, faBacon, faAppleWhole, faSnowflake,
    faEgg, faCheese, faSeedling, faBone, faFire, faBreadSlice,
    faWheatAwn, faFish, faPizzaSlice, faFlask, faJarWheat,
...
export const PREFERENCE_CATEGORIES = [
    ...
    { id: 'aperitivos',       label: 'Aperitivos',                                 prefixes: ['38'],            icon: faCookieBite },
    ...
    { id: 'bolleria',         label: 'Bollería industrial y galletas',             prefixes: ['31'],            icon: faCakeCandles },
    { id: 'cacao',            label: 'Cacao en polvo, azúcares, chucherías y miel',prefixes: ['37'],            icon: faMugHot },
    { id: 'casqueria',        label: 'Casquería',                                  prefixes: ['40'],            icon: faDrumstickBite },
    { id: 'cerdo',            label: 'Cerdo',                                      prefixes: ['2.4'],           icon: faPiggyBank },
    { id: 'cereales',         label: 'Cereales (excepto arroz)',                   prefixes: ['7'],             icon: faPlateWheat },
    { id: 'chocolates',       label: 'Chocolates y chocolatinas',                  prefixes: ['34'],            icon: faCookie },
    { id: 'cocina_esp',       label: 'Cocina tradicional española',                prefixes: ['39'],            icon: faUtensils },
    { id: 'comida_rapida',    label: 'Comida rápida',                              prefixes: ['49'],            icon: faBurger },
    { id: 'embutidos',        label: 'Embutidos',                                  prefixes: ['2.1'],           icon: faBacon },
    { id: 'fruta',            label: 'Fruta y derivados',                          prefixes: ['11'],            icon: faAppleWhole },
    { id: 'helados',          label: 'Helados y postres',                          prefixes: ['35', '36'],      icon: faSnowflake },
    ...
    { id: 'carnes_blancas',   label: 'Otras carnes blancas',                       prefixes: ['2.5'],           icon: faBone },
    { id: 'carnes_rojas',     label: 'Otras carnes rojas',                         prefixes: ['2.6'],           icon: faFire },
    { id: 'panes',            label: 'Panes y tortillas de trigo',                 prefixes: ['8'],             icon: faBreadSlice },
    { id: 'pasta',            label: 'Pasta, quinoa y derivados',                  prefixes: ['22'],            icon: faWheatAwn },
    ...
    { id: 'proteina_polvo',   label: 'Proteína en polvo y barritas proteicas',     prefixes: ['4', '29', '30'], icon: faFlask },
    ...
    { id: 'sopas',            label: 'Sopas y Caldos',                             prefixes: ['48'],            icon: faBowlFood },
    { id: 'superalimentos',   label: 'Superalimentos',                             prefixes: ['52'],            icon: faStar },
